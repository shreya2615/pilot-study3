...
function addBlockLabelToTrial(trial, blockLabel) {
  trial.timeline = trial.timeline.map(t => {
    const labelHtml = `<div style="text-align:center; font-size:20px; color:#999; opacity:1; position: fixed; top: 5px; left: 50%; transform: translateX(-50%); z-index: 1000;">
...
timeline.push({
  ...
  stimulus: `
    ...
    <p>
      <a href="https://connect.cloudresearch.com/participant/project/4DC7DE4B25/complete" target="_blank">
